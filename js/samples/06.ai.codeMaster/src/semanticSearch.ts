...
export function addSemanticSearch(app: Application, apiKey: string, maxTokens = 6000, maxDocuments = 5, maxChunks = 50): void {
    ...
    const index = new LocalDocumentIndex({
        embeddings,
        folderPath: path.join(__dirname, '../index/code'),
    });
